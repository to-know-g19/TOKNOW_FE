    ...
    return (
        ...
        <div className='d-flex justify-content-center col-12  '>
            ...
            <form className='d-flex mt-3 col-10 flex-column align-items-center justify-content-center'>
                <div className='col-10 d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <div className='d-flex align-items-center justify-content-center col-12 col-lg-5 flex-column'>
