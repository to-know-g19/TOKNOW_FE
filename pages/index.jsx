  ...
  return (
    <>
      ...
      <article className='sectionFourHome d-lg-flex col-lg-12'>
        <section className='col-6'> <img className='landingPicture' src="/images/stock.jpeg" alt="" /></section>
        <section className='landingTextNextToImg col-6'>
          <h3>Acompañando de la mano</h3>
          <div className='landingLogoNextToImg'><img src="/images/logotipo.svg" alt="" /></div>
